...
# 6. Feature column order (the exact 63 features the model expects)
target_cols = ["Value", "is_zero_value", "log_value"]
feature_cols = [c for c in df_features.columns if c not in target_cols]

# 7. One-hot column names for permit_category, sub_category, work_type
...
# 8. Median values for imputation at prediction time
